...
public class MainApp
{
    ...
    private static void fetchDetailsFromUdemy(final String mainUrl) {
        ...
        try {
            ...
            final String price = document.select("div.price-text--price-part--Tu6MH").first().text();
            if (!price.contains("Free")) {
                System.out.println("\nCoupon Expired...");
            }
            else {
                final String title = document.select("h1.udlite-heading-xl").first().text();
                final String time = document.select("div.discount-expiration--discount-expiration--2cPY2").first().getElementsByTag("b").text();
                final String rating = document.select("span.udlite-heading-sm").first().text();
                ...
                final String imgUrl = document.select("meta[property=og:image]").first().attr("content");
                final String template = "\ud83d\udcbb " + title + "\n\n\ud83d\uddc3 " + "\n\n\u23f3 Remaining : " + time + "\n\n\ud83c\udf1f Rating : " + rating + "/5.0" + "\n\n\ud83d\udd30 Direct Link\r\n" + "\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\r\n" + "\ud83d\udca5 " + shortUrl + "\n\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\u25ac\r\n" + "\r\n" + "\u276f\u276f Join Us On WhatsApp :\r\n" + "\u279c http://bit.ly/FreeProgrammingUdemyCourse\r\n" + "\r\n" + "\u276f\u276f Join Us On Telegram :\r\n" + "\u279c https://t.me/FreeProgrammingCourses";
                System.out.println("\n\n" + template);
